...
class ChatCLI {
  ...
  async start() {
    console.log("🚀 Starting Terminal MCP Chat CLI...\n");
    ...
    try {
      ...
      console.log("\n" + "=".repeat(60));
      console.log("🎉 WELCOME TO Terminal MCP CLI");
      console.log("=".repeat(60));
      console.log("Try these commands:");
      console.log("• 'Hello Alice' - Greeting tool");
      console.log("• 'What time is it?' - Time tool");  
      console.log("• 'Find largest file in current directory?' - Bash command tool");  
      console.log("• 'Give me verbose response' - Logging mode tool");
  ...
  private async isQuietMode(): Promise<boolean> {
    try {
      ...
      console.log(`🔍 Debug: Error checking quiet mode, defaulting to verbose`);
